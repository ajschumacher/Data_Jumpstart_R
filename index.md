...
## Data set: NYC public school attendance

* NYCDOE releases daily preliminary attendance figures per school and overall.
    * (link next page)
* My project to archive and help popularize the data:
    * [bit.ly/NYCattdarch](http://bit.ly/NYCattdarch) (archive in github repo)
    * [@NYCattends](https://twitter.com/NYCattends) (semi-automated account)

---

<center>
 <a style='border-bottom:none;' href='http://bit.ly/NYCattends'>
  <img src='assets/img/attd.png' height='600px' />
 </a>
</center>
...
## Data set: iris measurements

* Classic data set used in examples like this.
* 150 flowers measured 4 ways each, 50 each of 3 species
* Flowers are pretty.

---

<center>
 <a style='border-bottom:none;' href='http://en.wikipedia.org/wiki/Iris_flower_data_set'>
  <img src='assets/img/virginica.jpg' height='600px' />
 </a>
</center>
...
* Tonight! "Scraping twitter and other data with R"
    * with Pablo Barberà, author of the `streamR` package
    * 6:00 pm today (2013-03-26), third-floor lab, 19 W 4th
    * offered by the [Politics Data Lab](http://www.nyu.edu/projects/politicsdatalab/)
* Full range of future Data Services offerings:
    * [bit.ly/datatutorials](http://bit.ly/datatutorials)
